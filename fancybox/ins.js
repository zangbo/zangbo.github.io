  ...
  function(module, exports, __webpack_require__) {
    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'http://orwbuystz.bkt.clouddn.com/min_photos/' + data.link[i];
          var src = 'http://orwbuystz.bkt.clouddn.com/photos/' + data.link[i];
    ...
    function loadData(success) {
      if (!searchData) {
        ...
        xhr.open('GET', '/fancybox/data.json?t=' + +new Date(), true);
